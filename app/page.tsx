    ...
    <>
      ...
      <section className="works-with">
        ...
        <div className="agent-logos">
          ...
          <div className="agent-logo" title="OpenCode">
            <svg viewBox="0 0 240 300" fill="currentColor" aria-hidden="true">
              <path d="M180 240H60V120H180V240Z" fillOpacity="0.4"/>
              <path d="M180 60H60V240H180V60ZM240 300H0V0H240V300Z" fillRule="evenodd"/>
            </svg>
            <span>OpenCode</span>
          </div>
          <div className="agent-logo" title="Pi">
